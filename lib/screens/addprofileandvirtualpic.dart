...
class VirtualIDUpload extends StatefulWidget {
  const VirtualIDUpload({Key? key}) : super(key: key);

  @override
  _VirtualIDUploadState createState() => _VirtualIDUploadState();
}

class _VirtualIDUploadState extends State<VirtualIDUpload> {
  File? _image;
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (_platformFile != null) {
        ...
        CoolAlert.show(
          ...
          text: "Virtual ID image submitted successfully!",
